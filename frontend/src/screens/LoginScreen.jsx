...
const LoginScreen = () => {
  ...
  const loginOnSubmit = async (e) => {
    ...
    try {
      ...
      const rawToken = res?.meta?.response?.headers?.get('authorization');
      ...
      <div className="flex justify-center items-center h-screen">
        <div className="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
          <div className="max-w-md w-full p-6">
            ...
            <form onSubmit={loginOnSubmit} action="#" method="POST" className="space-y-4">
              <div>
            ...
            <div className="mt-4 text-sm text-gray-600 text-center">
              <p>No account yet ? <Link to="/register" className="text-black hover:underline">Sign-up here</Link>
              </p>
            </div>
          </div>
        </div>
